...
implements pk {
    ...
    private static void a(File[] arrfile) {
        for (int i2 = 0; i2 < arrfile.length; ++i2) {
            if (arrfile[i2].isDirectory()) {
                cy.a(arrfile[i2].listFiles());
            }
            arrfile[i2].delete();
        }
    }
    ...
    public void a(ch ch2, int n2, int n3, int n4, int n5) {
        ...
        } else if (ch2 == ch.b && nq.s[n6 = this.a(n2, n3, n4)] > n5) {
            n5 = nq.s[n6];
        }
    ...
    public nx a(ao ao2, ao ao3) {
        return this.a(ao2, ao3, false);
    }

    public nx a(ao ao2, ao ao3, boolean bl2) {
    ...
    public int a(float f2) {
        float f3 = this.b(f2);
        float f4 = 1.0f - (fi.b((float)(f3 * (float)Math.PI * 2.0f)) * 2.0f + 0.5f);
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 1.0f) {
    ...
    public ao a(lw lw2, float f2) {
        float f3 = this.b(f2);
        float f4 = fi.b((float)(f3 * (float)Math.PI * 2.0f)) * 2.0f + 0.5f;
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 1.0f) {
    ...
    public ao c(float f2) {
        ...
        return ao.b(f5 *= f4 * 0.9f + 0.1f, f6 *= f4 * 0.9f + 0.1f, f7 *= f4 * 0.85f + 0.15f);
    }

    public ao d(float f2) {
        float f3 = this.b(f2);
    ...
    public float e(float f2) {
        float f3 = this.b(f2);
        float f4 = 1.0f - (fi.b((float)(f3 * (float)Math.PI * 2.0f)) * 2.0f + 0.75f);
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 1.0f) {
    ...
    public void e() {
        ...
        for (n4 = 0; n4 < this.b.size(); ++n4) {
            ...
            if (((lw)object).ar != null) {
                if (!object.ar.aN && object.ar.aq == object) continue;
                object.ar.aq = null;
                ((lw)object).ar = null;
            }
            if (!((lw)object).aN) {
        ...
        while (f2 <= 1.0f) {
            ...
            while (f3 <= 1.0f) {
                ...
                while (f4 <= 1.0f) {
                    ...
                    if (this.a(ao.b(d5, d6, d7), ao2) == null) {
                        ++n2;
                    }
                    ++n3;
    ...
    protected void j() {
        ...
        for (Object object : this.K) {
            ...
            if (this.L == 0) {
                ...
                n8 = n3 >> 16 & 0x7F;
                n7 = ha2.a(n2, n8, n9);
                if (n7 == 0 && this.j(n2 += n5, n8, n9 += n4) <= this.l.nextInt(8) && this.a(ch.a, n2, n8, n9) <= 0 && (eb2 = this.a((double)n2 + 0.5, (double)n8 + 0.5, (double)n9 + 0.5, 8.0)) != null && eb2.e((double)n2 + 0.5, (double)n8 + 0.5, (double)n9 + 0.5) > 4.0) {
    ...
    public List a(Class class_, co co2) {
        int n2 = fi.b((co2.a - 2.0) / 16.0);
        int n3 = fi.b((co2.d + 2.0) / 16.0);
        int n4 = fi.b((co2.c - 2.0) / 16.0);
        int n5 = fi.b((co2.f + 2.0) / 16.0);
        ...
        for (int i2 = n2; i2 <= n3; ++i2) {
            for (int i3 = n4; i3 <= n5; ++i3) {
                if (!this.g(i2, i3)) continue;
                this.c(i2, i3).a(class_, co2, arrayList);
            }
        }
        return arrayList;
    }
    ...
    public int b(Class class_) {
        int n2 = 0;
        for (int i2 = 0; i2 < this.b.size(); ++i2) {
            lw lw2 = (lw)this.b.get(i2);
            if (!class_.isAssignableFrom(lw2.getClass())) continue;
            ++n2;
        }
        return n2;
    }
    ...
    public void a(int n2, int n3, int n4, int n5, int n6, int n7, byte[] arrby) {
        int n8 = n2 >> 4;
        int n9 = n4 >> 4;
        int n10 = n2 + n5 - 1 >> 4;
        int n11 = n4 + n7 - 1 >> 4;
        ...
        for (int i2 = n8; i2 <= n10; ++i2) {
            ...
            for (int i3 = n9; i3 <= n11; ++i3) {
                ...
                n12 = this.c(i2, i3).a(arrby, n15, n13, n17, n16, n14, n18, n12);
