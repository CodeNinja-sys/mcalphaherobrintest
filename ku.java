...
public class ku {
    ...
    public void a(float f2) {
        ...
        GL11.glRotatef(bq2.aE + (bq2.aC - bq2.aE) * f2, 0.0f, 1.0f, 0.0f);
        l.b();
        GL11.glPopMatrix();
        ...
        if (fp2 != null) {
            ...
            float f5 = 0.8f;
            float f6 = bq2.d(f2);
            float f7 = fi.a((float)(f6 * (float)Math.PI));
            float f8 = fi.a((float)(fi.c((float)f6) * (float)Math.PI));
            GL11.glTranslatef(-f8 * 0.4f, fi.a((float)(fi.c((float)f6) * (float)Math.PI * 2.0f)) * 0.2f, -f7 * 0.2f);
            GL11.glTranslatef(0.7f * f5, -0.65f * f5 - (1.0f - f3) * 0.6f, -0.9f * f5);
            GL11.glRotatef(45.0f, 0.0f, 1.0f, 0.0f);
            GL11.glEnable(32826);
            f6 = bq2.d(f2);
            f7 = fi.a((float)(f6 * f6 * (float)Math.PI));
            f8 = fi.a((float)(fi.c((float)f6) * (float)Math.PI));
            ...
            float f9 = 0.8f;
            float f10 = bq2.d(f2);
            float f11 = fi.a((float)(f10 * (float)Math.PI));
            float f12 = fi.a((float)(fi.c((float)f10) * (float)Math.PI));
            GL11.glTranslatef(-f12 * 0.3f, fi.a((float)(fi.c((float)f10) * (float)Math.PI * 2.0f)) * 0.4f, -f11 * 0.4f);
            GL11.glTranslatef(0.8f * f9, -0.75f * f9 - (1.0f - f3) * 0.6f, -0.9f * f9);
            GL11.glRotatef(45.0f, 0.0f, 1.0f, 0.0f);
            GL11.glEnable(32826);
            f10 = bq2.d(f2);
            f11 = fi.a((float)(f10 * f10 * (float)Math.PI));
            f12 = fi.a((float)(fi.c((float)f10) * (float)Math.PI));
            GL11.glRotatef(f12 * 70.0f, 0.0f, 1.0f, 0.0f);
