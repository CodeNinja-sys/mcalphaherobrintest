...
public class ha {
    ...
    public ha(cy cy2, byte[] arrby, int n2, int n3) {
        this(cy2, n2, n3);
        this.b = arrby;
        this.e = new oo(arrby.length);
        this.f = new oo(arrby.length);
        this.g = new oo(arrby.length);
    }
    ...
    public void d() {
        ...
        this.d.a(ch.b, this.j * 16, n2 - 1, this.k * 16, this.j * 16 + 16, n2 + 1, this.k * 16 + 16);
        this.o = true;
    }
    ...
    private void f(int n2, int n3, int n4) {
        ...
        if (n5 > n4) {
            this.d.a(ch.a, n2, n4, n3, n2, n5, n3);
        } else if (n5 < n4) {
            this.d.a(ch.a, n2, n5, n3, n2, n4, n3);
        }
        this.o = true;
    }
    ...
    private void g(int n2, int n3, int n4) {
        ...
        if (n9 < n8) {
            ...
            this.d.a(ch.a, n7, n8, n6, n7, n9, n6);
            for (n5 = n8; n5 < n9; ++n5) {
                this.f.a(n2, n5, n4, 0);
            }
        }
        ...
        if (n9 != n11) {
            this.d.a(ch.a, n7 - 1, n9, n6 - 1, n7 + 1, n11, n6 + 1);
        }
        this.o = true;
    }
    ...
    public boolean a(int n2, int n3, int n4, int n5, int n6) {
        ...
        if (!this.d.q.e) {
            ...
            this.d.a(ch.a, n9, n3, n10, n9, n3, n10);
        }
        this.d.a(ch.b, n9, n3, n10, n9, n3, n10);
        this.c(n2, n4);
        if (n5 != 0) {
    ...
    public boolean a(int n2, int n3, int n4, int n5) {
        ...
        this.d.a(ch.a, n8, n3, n9, n8, n3, n9);
        this.d.a(ch.b, n8, n3, n9, n8, n3, n9);
        this.c(n2, n4);
        if (n5 != 0 && !this.d.z) {
    ...
    public void a(Class class_, co co2, List list) {
        int n2 = fi.b((co2.b - 2.0) / 16.0);
        int n3 = fi.b((co2.e + 2.0) / 16.0);
        if (n2 < 0) {
            n2 = 0;
        ...
        for (int i2 = n2; i2 <= n3; ++i2) {
            ...
            for (int i3 = 0; i3 < list2.size(); ++i3) {
                ...
                if (!class_.isAssignableFrom(lw2.getClass()) || !lw2.aG.a(co2)) continue;
                list.add(lw2);
            }
        }
    }
    ...
    public int a(byte[] arrby, int n2, int n3, int n4, int n5, int n6, int n7, int n8) {
        ...
        for (n12 = n2; n12 < n5; ++n12) {
            for (n11 = n4; n11 < n7; ++n11) {
                n10 = n12 << 11 | n11 << 7 | n3;
                n9 = n6 - n3;
                System.arraycopy(arrby, n8, this.b, n10, n9);
                n8 += n9;
            }
        }
        this.b();
        for (n12 = n2; n12 < n5; ++n12) {
            for (n11 = n4; n11 < n7; ++n11) {
                ...
                n9 = (n6 - n3) / 2;
                System.arraycopy(arrby, n8, this.e.a, n10, n9);
                n8 += n9;
            }
        }
        for (n12 = n2; n12 < n5; ++n12) {
            for (n11 = n4; n11 < n7; ++n11) {
                n10 = (n12 << 11 | n11 << 7 | n3) >> 1;
                n9 = (n6 - n3) / 2;
                System.arraycopy(arrby, n8, this.g.a, n10, n9);
                n8 += n9;
            }
        }
        for (n12 = n2; n12 < n5; ++n12) {
            for (n11 = n4; n11 < n7; ++n11) {
                n10 = (n12 << 11 | n11 << 7 | n3) >> 1;
                n9 = (n6 - n3) / 2;
                System.arraycopy(arrby, n8, this.f.a, n10, n9);
                n8 += n9;
            }
        }
        return n8;
