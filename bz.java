...
public class bz {
    ...
    public void a(lw lw2, float f2) {
        float f3 = fi.b((float)(lw2.aC * (float)Math.PI / 180.0f));
        float f4 = fi.a((float)(lw2.aC * (float)Math.PI / 180.0f));
        float f5 = -f4 * fi.a((float)(lw2.aD * (float)Math.PI / 180.0f));
        float f6 = f3 * fi.a((float)(lw2.aD * (float)Math.PI / 180.0f));
        float f7 = fi.b((float)(lw2.aD * (float)Math.PI / 180.0f));
