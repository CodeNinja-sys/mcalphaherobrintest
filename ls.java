...
public class ls {
    ...
    public ls(gq gq2, String string, fu fu2) {
        ...
        bufferedImage.getRGB(0, 0, n7, n8, arrn, 0, n7);
        ...
        for (n6 = 0; n6 < 256; ++n6) {
            ...
            is2.a();
            GL11.glTranslatef(this.b[n6], 0.0f, 0.0f);
            GL11.glEndList();
        }
        for (n6 = 0; n6 < 32; ++n6) {
            boolean bl3;
            ...
            GL11.glNewList(this.c + 256 + n6, 4864);
            GL11.glColor3f((float)n4 / 255.0f, (float)n10 / 255.0f, (float)n11 / 255.0f);
            GL11.glEndList();
        }
    }
