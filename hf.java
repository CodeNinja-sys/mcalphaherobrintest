...
extends lw {
    ...
    public boolean d(lw lw2) {
        return this.as.a(ao.b(this.aw, this.ax + (double)this.v(), this.ay), ao.b(lw2.aw, lw2.ax + (double)lw2.v(), lw2.ay)) == null;
    }
    ...
    public void a(lw lw2, int n2, double d2, double d3) {
        float f2 = fi.a((double)(d2 * d2 + d3 * d3));
        float f3 = 0.4f;
        this.az /= 2.0;
        this.aA /= 2.0;
        this.aB /= 2.0;
    ...
    public void b(float f2, float f3) {
        ...
        float f6 = fi.a((double)(d4 * d4 + d5 * d5)) * 4.0f;
        if (f6 > 1.0f) {
            f6 = 1.0f;
        }
    ...
    public void b(lw lw2, float f2) {
        ...
        double d5 = fi.a((double)(d3 * d3 + d4 * d4));
    ...
    public ao f(float f2) {
        if (f2 == 1.0f) {
            float f3 = fi.b((float)(-this.aC * ((float)Math.PI / 180) - (float)Math.PI));
            float f4 = fi.a((float)(-this.aC * ((float)Math.PI / 180) - (float)Math.PI));
            float f5 = -fi.b((float)(-this.aD * ((float)Math.PI / 180)));
            float f6 = fi.a((float)(-this.aD * ((float)Math.PI / 180)));
            return ao.b(f4 * f5, f6, f3 * f5);
        }
        ...
        float f11 = -fi.b((float)(-f7 * ((float)Math.PI / 180)));
        float f12 = fi.a((float)(-f7 * ((float)Math.PI / 180)));
        return ao.b(f10 * f11, f12, f9 * f11);
    }
