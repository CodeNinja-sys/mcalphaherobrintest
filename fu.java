...
public class fu {
    ...
    public void a(BufferedImage bufferedImage, int n2) {
        ...
        int[] arrn = new int[n11 * n12];
        byte[] arrby = new byte[n11 * n12 * 4];
        bufferedImage.getRGB(0, 0, n11, n12, arrn, 0, n11);
        for (n10 = 0; n10 < arrn.length; ++n10) {
            n9 = arrn[n10] >> 24 & 0xFF;
            n8 = arrn[n10] >> 16 & 0xFF;
            n7 = arrn[n10] >> 8 & 0xFF;
            n6 = arrn[n10] & 0xFF;
            ...
            arrby[n10 * 4 + 0] = (byte)n8;
            arrby[n10 * 4 + 1] = (byte)n7;
            arrby[n10 * 4 + 2] = (byte)n6;
            arrby[n10 * 4 + 3] = (byte)n9;
        }
        this.e.clear();
        this.e.put(arrby);
        this.e.position(0).limit(arrby.length);
        GL11.glTexImage2D(3553, 0, 6408, n11, n12, 0, 6408, 5121, this.e);
        if (a) {
            for (n10 = 1; n10 <= 4; ++n10) {
                n9 = n11 >> n10 - 1;
                n8 = n11 >> n10;
                ...
                GL11.glTexImage2D(3553, n10, 6408, n8, n7, 0, 6408, 5121, this.e);
            }
        }
    }
    ...
    public void a() {
        ...
        for (n12 = 0; n12 < this.f.size(); ++n12) {
            ...
            for (n11 = 0; n11 < ad2.e; ++n11) {
                for (n10 = 0; n10 < ad2.e; ++n10) {
                    GL11.glTexSubImage2D(3553, 0, ad2.b % 16 * 16 + n11 * 16, ad2.b / 16 * 16 + n10 * 16, 16, 16, 6408, 5121, this.e);
                    if (!a) continue;
                    for (n9 = 1; n9 <= 4; ++n9) {
                        n8 = 16 >> n9 - 1;
                        n7 = 16 >> n9;
                        ...
                        GL11.glTexSubImage2D(3553, n9, ad2.b % 16 * n7, ad2.b / 16 * n7, n7, n7, 6408, 5121, this.e);
                    }
                }
            }
        }
        for (n12 = 0; n12 < this.f.size(); ++n12) {
            ...
            for (n11 = 1; n11 <= 4; ++n11) {
                ...
                GL11.glTexSubImage2D(3553, n11, 0, 0, n9, n9, 6408, 5121, this.e);
            }
        }
    }
