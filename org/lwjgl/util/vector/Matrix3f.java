...
implements Serializable {
    ...
    public static Vector3f transform(Matrix3f left, Vector3f right, Vector3f dest) {
        ...
        float x2 = left.m00 * right.x + left.m10 * right.y + left.m20 * right.z;
        float y2 = left.m01 * right.x + left.m11 * right.y + left.m21 * right.z;
        float z2 = left.m02 * right.x + left.m12 * right.y + left.m22 * right.z;
        dest.x = x2;
        dest.y = y2;
        dest.z = z2;
        return dest;
    ...
    public static Matrix3f setIdentity(Matrix3f m2) {
        m2.m00 = 1.0f;
        m2.m01 = 0.0f;
        m2.m02 = 0.0f;
        m2.m10 = 0.0f;
    ...
    public static Matrix3f setZero(Matrix3f m2) {
        m2.m00 = 0.0f;
        m2.m01 = 0.0f;
        m2.m02 = 0.0f;
        m2.m10 = 0.0f;
