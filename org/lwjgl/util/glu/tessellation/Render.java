...
class Render {
    ...
    implements renderCallBack {
        ...
        static {
            $assertionsDisabled = !(class$org$lwjgl$util$glu$tessellation$Render == null ? (class$org$lwjgl$util$glu$tessellation$Render = Render.class$("org.lwjgl.util.glu.tessellation.Render")) : class$org$lwjgl$util$glu$tessellation$Render).desiredAssertionStatus();
        }
    }
