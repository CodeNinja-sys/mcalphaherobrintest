...
class Mesh {
    ...
    static void MakeVertex(GLUvertex newVertex, GLUhalfEdge eOrig, GLUvertex vNext) {
        ...
        if (!$assertionsDisabled && vNew == null) {
    ...
    static void MakeFace(GLUface newFace, GLUhalfEdge eOrig, GLUface fNext) {
        ...
        if (!$assertionsDisabled && fNew == null) {
            throw new AssertionError();
        }
    ...
    public static void __gl_meshCheckMesh(GLUmesh mesh) {
        ...
        while ((f2 = fPrev.next) != fHead) {
            if (!$assertionsDisabled && f2.prev != fPrev) {
                throw new AssertionError();
            }
            e2 = f2.anEdge;
            do {
                ...
                if (!$assertionsDisabled && e2.Lface != f2) {
                    throw new AssertionError();
                }
            } while ((e2 = e2.Lnext) != f2.anEdge);
            fPrev = f2;
        }
        if (!($assertionsDisabled || f2.prev == fPrev && f2.anEdge == null && f2.data == null)) {
            throw new AssertionError();
        }
        GLUvertex vPrev = vHead;
        vPrev = vHead;
        while ((v2 = vPrev.next) != vHead) {
            if (!$assertionsDisabled && v2.prev != vPrev) {
                throw new AssertionError();
            }
            e2 = v2.anEdge;
            do {
                ...
                if (!$assertionsDisabled && e2.Org != v2) {
                    throw new AssertionError();
                }
            } while ((e2 = e2.Onext) != v2.anEdge);
            vPrev = v2;
        }
        if (!($assertionsDisabled || v2.prev == vPrev && v2.anEdge == null && v2.data == null)) {
            throw new AssertionError();
        }
        GLUhalfEdge ePrev = eHead;
        ePrev = eHead;
        while ((e2 = ePrev.next) != eHead) {
            if (!$assertionsDisabled && e2.Sym.next != ePrev.Sym) {
                throw new AssertionError();
            }
            if (!$assertionsDisabled && e2.Sym == e2) {
                throw new AssertionError();
            ...
            if (!$assertionsDisabled && e2.Org == null) {
                throw new AssertionError();
            }
            if (!$assertionsDisabled && e2.Sym.Org == null) {
                throw new AssertionError();
            }
            if (!$assertionsDisabled && e2.Lnext.Onext.Sym != e2) {
                throw new AssertionError();
        ...
        if (!($assertionsDisabled || e2.Sym.next == ePrev.Sym && e2.Sym == mesh.eHeadSym && e2.Sym.Sym == e2 && e2.Org == null && e2.Sym.Org == null && e2.Lface == null && e2.Sym.Lface == null)) {
            throw new AssertionError();
        }
    }
