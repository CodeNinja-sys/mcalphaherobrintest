...
public final class ATIFragmentShader {
    ...
    private static native int nglGenFragmentShadersATI(int var0, long var1);

    public static void glBindFragmentShaderATI(int id2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glBindFragmentShaderATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglBindFragmentShaderATI(id2, function_pointer);
    }

    private static native void nglBindFragmentShaderATI(int var0, long var1);

    public static void glDeleteFragmentShaderATI(int id2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glDeleteFragmentShaderATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglDeleteFragmentShaderATI(id2, function_pointer);
    }

    private static native void nglDeleteFragmentShaderATI(int var0, long var1);
    ...
    private static native void nglBeginFragmentShaderATI(long var0);
    ...
    private static native void nglEndFragmentShaderATI(long var0);
    ...
    private static native void nglPassTexCoordATI(int var0, int var1, int var2, long var3);
    ...
    private static native void nglSampleMapATI(int var0, int var1, int var2, long var3);

    public static void glColorFragmentOp1ATI(int op2, int dst, int dstMask, int dstMod, int arg1, int arg1Rep, int arg1Mod) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glColorFragmentOp1ATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglColorFragmentOp1ATI(op2, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod, function_pointer);
    }

    private static native void nglColorFragmentOp1ATI(int var0, int var1, int var2, int var3, int var4, int var5, int var6, long var7);

    public static void glColorFragmentOp2ATI(int op2, int dst, int dstMask, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glColorFragmentOp2ATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglColorFragmentOp2ATI(op2, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep, arg2Mod, function_pointer);
    }

    private static native void nglColorFragmentOp2ATI(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, long var10);

    public static void glColorFragmentOp3ATI(int op2, int dst, int dstMask, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod, int arg3, int arg3Rep, int arg3Mod) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glColorFragmentOp3ATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglColorFragmentOp3ATI(op2, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep, arg2Mod, arg3, arg3Rep, arg3Mod, function_pointer);
    }

    private static native void nglColorFragmentOp3ATI(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, long var13);

    public static void glAlphaFragmentOp1ATI(int op2, int dst, int dstMod, int arg1, int arg1Rep, int arg1Mod) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glAlphaFragmentOp1ATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglAlphaFragmentOp1ATI(op2, dst, dstMod, arg1, arg1Rep, arg1Mod, function_pointer);
    }

    private static native void nglAlphaFragmentOp1ATI(int var0, int var1, int var2, int var3, int var4, int var5, long var6);

    public static void glAlphaFragmentOp2ATI(int op2, int dst, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glAlphaFragmentOp2ATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglAlphaFragmentOp2ATI(op2, dst, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep, arg2Mod, function_pointer);
    }

    private static native void nglAlphaFragmentOp2ATI(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9);

    public static void glAlphaFragmentOp3ATI(int op2, int dst, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod, int arg3, int arg3Rep, int arg3Mod) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_fragment_shader_glAlphaFragmentOp3ATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIFragmentShader.nglAlphaFragmentOp3ATI(op2, dst, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep, arg2Mod, arg3, arg3Rep, arg3Mod, function_pointer);
    }

    private static native void nglAlphaFragmentOp3ATI(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, long var12);
    ...
    public static void glSetFragmentShaderConstantATI(int dst, FloatBuffer pfValue) {
        ...
        ATIFragmentShader.nglSetFragmentShaderConstantATI(dst, pfValue, pfValue.position(), function_pointer);
    }

    private static native void nglSetFragmentShaderConstantATI(int var0, FloatBuffer var1, int var2, long var3);
}
