...
public final class EXTVertexWeighting {
    ...
    private static native void nglVertexWeightfEXT(float var0, long var1);
    ...
    public static void glVertexWeightPointerEXT(int size, int stride, FloatBuffer pPointer) {
        ...
        GLChecks.getReferences((ContextCapabilities)caps).EXT_vertex_weighting_glVertexWeightPointerEXT_pPointer = pPointer;
        EXTVertexWeighting.nglVertexWeightPointerEXT(size, 5126, stride, pPointer, pPointer.position() << 2, function_pointer);
    }

    private static native void nglVertexWeightPointerEXT(int var0, int var1, int var2, Buffer var3, int var4, long var5);
    ...
    private static native void nglVertexWeightPointerEXTBO(int var0, int var1, int var2, long var3, long var5);
}
