...
public final class NVPixelDataRange {
    ...
    public static void glPixelDataRangeNV(int target, ByteBuffer data) {
        ...
        NVPixelDataRange.nglPixelDataRangeNV(target, data.remaining(), data, data.position(), function_pointer);
    }
    ...
    public static void glPixelDataRangeNV(int target, DoubleBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        NVPixelDataRange.nglPixelDataRangeNV(target, data.remaining() << 3, data, data.position() << 3, function_pointer);
    }
    ...
    public static void glPixelDataRangeNV(int target, FloatBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        NVPixelDataRange.nglPixelDataRangeNV(target, data.remaining() << 2, data, data.position() << 2, function_pointer);
    }
    ...
    public static void glPixelDataRangeNV(int target, ShortBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        NVPixelDataRange.nglPixelDataRangeNV(target, data.remaining() << 1, data, data.position() << 1, function_pointer);
    }

    private static native void nglPixelDataRangeNV(int var0, int var1, Buffer var2, int var3, long var4);
    ...
    private static native void nglFlushPixelDataRangeNV(int var0, long var1);
}
