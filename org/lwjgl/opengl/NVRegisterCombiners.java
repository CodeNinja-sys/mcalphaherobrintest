...
public final class NVRegisterCombiners {
    ...
    private static native void nglCombinerParameterfNV(int var0, float var1, long var2);
    ...
    public static void glCombinerParameterNV(int pname, FloatBuffer params) {
        ...
        NVRegisterCombiners.nglCombinerParameterfvNV(pname, params, params.position(), function_pointer);
    }

    private static native void nglCombinerParameterfvNV(int var0, FloatBuffer var1, int var2, long var3);
    ...
    private static native void nglCombinerParameteriNV(int var0, int var1, long var2);
    ...
    public static void glCombinerParameterNV(int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglCombinerParameterivNV(pname, params, params.position(), function_pointer);
    }

    private static native void nglCombinerParameterivNV(int var0, IntBuffer var1, int var2, long var3);
    ...
    private static native void nglCombinerInputNV(int var0, int var1, int var2, int var3, int var4, int var5, long var6);
    ...
    private static native void nglCombinerOutputNV(int var0, int var1, int var2, int var3, int var4, int var5, int var6, boolean var7, boolean var8, boolean var9, long var10);
    ...
    private static native void nglFinalCombinerInputNV(int var0, int var1, int var2, int var3, long var4);
    ...
    public static void glGetCombinerInputParameterNV(int stage, int portion, int variable, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerInputParameterfvNV(stage, portion, variable, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetCombinerInputParameterfvNV(int var0, int var1, int var2, int var3, FloatBuffer var4, int var5, long var6);
    ...
    public static void glGetCombinerInputParameterNV(int stage, int portion, int variable, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerInputParameterivNV(stage, portion, variable, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetCombinerInputParameterivNV(int var0, int var1, int var2, int var3, IntBuffer var4, int var5, long var6);
    ...
    public static void glGetCombinerOutputParameterNV(int stage, int portion, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerOutputParameterfvNV(stage, portion, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetCombinerOutputParameterfvNV(int var0, int var1, int var2, FloatBuffer var3, int var4, long var5);
    ...
    public static void glGetCombinerOutputParameterNV(int stage, int portion, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerOutputParameterivNV(stage, portion, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetCombinerOutputParameterivNV(int var0, int var1, int var2, IntBuffer var3, int var4, long var5);
    ...
    public static void glGetFinalCombinerInputParameterNV(int variable, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetFinalCombinerInputParameterfvNV(variable, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetFinalCombinerInputParameterfvNV(int var0, int var1, FloatBuffer var2, int var3, long var4);
    ...
    public static void glGetFinalCombinerInputParameterNV(int variable, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetFinalCombinerInputParameterivNV(variable, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetFinalCombinerInputParameterivNV(int var0, int var1, IntBuffer var2, int var3, long var4);
