...
public final class ATIDrawBuffers {
    ...
    public static void glDrawBuffersATI(IntBuffer buffers) {
        ...
        ATIDrawBuffers.nglDrawBuffersATI(buffers.remaining(), buffers, buffers.position(), function_pointer);
    }

    private static native void nglDrawBuffersATI(int var0, IntBuffer var1, int var2, long var3);

    public static void glDrawBuffersATI(int buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.ATI_draw_buffers_glDrawBuffersATI_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIDrawBuffers.nglDrawBuffersATI(1, APIUtils.getBufferInt().put(0, buffer), 0, function_pointer);
    }
}
