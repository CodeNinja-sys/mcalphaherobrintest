...
public final class EXTTextureInteger {
    ...
    public static void glClearColorIiEXT(int r2, int g2, int b2, int a2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.EXT_texture_integer_glClearColorIiEXT_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglClearColorIiEXT(r2, g2, b2, a2, function_pointer);
    }

    private static native void nglClearColorIiEXT(int var0, int var1, int var2, int var3, long var4);

    public static void glClearColorIuiEXT(int r2, int g2, int b2, int a2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.EXT_texture_integer_glClearColorIuiEXT_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglClearColorIuiEXT(r2, g2, b2, a2, function_pointer);
    }

    private static native void nglClearColorIuiEXT(int var0, int var1, int var2, int var3, long var4);
    ...
    public static void glTexParameterIEXT(int target, int pname, IntBuffer params) {
        ...
        EXTTextureInteger.nglTexParameterIivEXT(target, pname, params, params.position(), function_pointer);
    }

    private static native void nglTexParameterIivEXT(int var0, int var1, IntBuffer var2, int var3, long var4);

    public static void glTexParameterIiEXT(int target, int pname, int param) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.EXT_texture_integer_glTexParameterIivEXT_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglTexParameterIivEXT(target, pname, APIUtils.getBufferInt().put(0, param), 0, function_pointer);
    }
    ...
    public static void glTexParameterIuEXT(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTTextureInteger.nglTexParameterIuivEXT(target, pname, params, params.position(), function_pointer);
    }

    private static native void nglTexParameterIuivEXT(int var0, int var1, IntBuffer var2, int var3, long var4);

    public static void glTexParameterIuiEXT(int target, int pname, int param) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.EXT_texture_integer_glTexParameterIuivEXT_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglTexParameterIuivEXT(target, pname, APIUtils.getBufferInt().put(0, param), 0, function_pointer);
    }
    ...
    public static void glGetTexParameterIEXT(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTTextureInteger.nglGetTexParameterIivEXT(target, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetTexParameterIivEXT(int var0, int var1, IntBuffer var2, int var3, long var4);
    ...
    public static void glGetTexParameterIuEXT(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTTextureInteger.nglGetTexParameterIuivEXT(target, pname, params, params.position(), function_pointer);
    }

    private static native void nglGetTexParameterIuivEXT(int var0, int var1, IntBuffer var2, int var3, long var4);
