...
public final class GL14 {
    ...
    private static native void nglFogCoordf(float var0, long var1);
    ...
    private static native void nglFogCoordd(double var0, long var2);
    ...
    public static void glFogCoordPointer(int stride, DoubleBuffer data) {
        ...
        GLChecks.getReferences((ContextCapabilities)caps).GL14_glFogCoordPointer_data = data;
        GL14.nglFogCoordPointer(5130, stride, data, data.position() << 3, function_pointer);
    }
    ...
    public static void glFogCoordPointer(int stride, FloatBuffer data) {
        ...
        BufferChecks.checkDirect(data);
        GLChecks.getReferences((ContextCapabilities)caps).GL14_glFogCoordPointer_data = data;
        GL14.nglFogCoordPointer(5126, stride, data, data.position() << 2, function_pointer);
    }

    private static native void nglFogCoordPointer(int var0, int var1, Buffer var2, int var3, long var4);
    ...
    private static native void nglFogCoordPointerBO(int var0, int var1, long var2, long var4);
    ...
    public static void glMultiDrawArrays(int mode, IntBuffer piFirst, IntBuffer piCount) {
        ...
        GL14.nglMultiDrawArrays(mode, piFirst, piFirst.position(), piCount, piCount.position(), piFirst.remaining(), function_pointer);
    }

    private static native void nglMultiDrawArrays(int var0, IntBuffer var1, int var2, IntBuffer var3, int var4, int var5, long var6);
    ...
    private static native void nglPointParameteri(int var0, int var1, long var2);
    ...
    private static native void nglPointParameterf(int var0, float var1, long var2);
    ...
    public static void glPointParameter(int pname, IntBuffer params) {
        ...
        GL14.nglPointParameteriv(pname, params, params.position(), function_pointer);
    }

    private static native void nglPointParameteriv(int var0, IntBuffer var1, int var2, long var3);
    ...
    public static void glPointParameter(int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL14.nglPointParameterfv(pname, params, params.position(), function_pointer);
    }

    private static native void nglPointParameterfv(int var0, FloatBuffer var1, int var2, long var3);
    ...
    private static native void nglSecondaryColor3b(byte var0, byte var1, byte var2, long var3);
    ...
    private static native void nglSecondaryColor3f(float var0, float var1, float var2, long var3);
    ...
    private static native void nglSecondaryColor3d(double var0, double var2, double var4, long var6);
    ...
    private static native void nglSecondaryColor3ub(byte var0, byte var1, byte var2, long var3);
    ...
    public static void glSecondaryColorPointer(int size, int stride, DoubleBuffer data) {
        ...
        GLChecks.ensureArrayVBOdisabled(caps);
        BufferChecks.checkDirect(data);
        GL14.nglSecondaryColorPointer(size, 5130, stride, data, data.position() << 3, function_pointer);
    }
    ...
    public static void glSecondaryColorPointer(int size, int stride, FloatBuffer data) {
        ...
        GLChecks.ensureArrayVBOdisabled(caps);
        BufferChecks.checkDirect(data);
        GL14.nglSecondaryColorPointer(size, 5126, stride, data, data.position() << 2, function_pointer);
    }
    ...
    public static void glSecondaryColorPointer(int size, boolean unsigned, int stride, ByteBuffer data) {
        ...
        GLChecks.ensureArrayVBOdisabled(caps);
        BufferChecks.checkDirect(data);
        GL14.nglSecondaryColorPointer(size, unsigned ? 5121 : 5120, stride, data, data.position(), function_pointer);
    }

    private static native void nglSecondaryColorPointer(int var0, int var1, int var2, Buffer var3, int var4, long var5);
    ...
    private static native void nglSecondaryColorPointerBO(int var0, int var1, int var2, long var3, long var5);
    ...
    private static native void nglBlendFuncSeparate(int var0, int var1, int var2, int var3, long var4);

    public static void glWindowPos2f(float x2, float y2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.GL14_glWindowPos2f_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos2f(x2, y2, function_pointer);
    }

    private static native void nglWindowPos2f(float var0, float var1, long var2);

    public static void glWindowPos2d(double x2, double y2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.GL14_glWindowPos2d_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos2d(x2, y2, function_pointer);
    }

    private static native void nglWindowPos2d(double var0, double var2, long var4);

    public static void glWindowPos2i(int x2, int y2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.GL14_glWindowPos2i_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos2i(x2, y2, function_pointer);
    }

    private static native void nglWindowPos2i(int var0, int var1, long var2);

    public static void glWindowPos3f(float x2, float y2, float z2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.GL14_glWindowPos3f_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos3f(x2, y2, z2, function_pointer);
    }

    private static native void nglWindowPos3f(float var0, float var1, float var2, long var3);

    public static void glWindowPos3d(double x2, double y2, double z2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.GL14_glWindowPos3d_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos3d(x2, y2, z2, function_pointer);
    }

    private static native void nglWindowPos3d(double var0, double var2, double var4, long var6);

    public static void glWindowPos3i(int x2, int y2, int z2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.GL14_glWindowPos3i_pointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos3i(x2, y2, z2, function_pointer);
    }

    private static native void nglWindowPos3i(int var0, int var1, int var2, long var3);
}
