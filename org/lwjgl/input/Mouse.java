...
public class Mouse {
    ...
    private static final boolean allowNegativeMouseCoords;
    ...
    private static void initialize() {
        ...
        for (int i2 = 0; i2 < 16; ++i2) {
            ...
            buttonMap.put(buttonName[i2], new Integer(i2));
        }
        initialized = true;
    }
    ...
    public static boolean next() {
        ...
        synchronized (object) {
            ...
            if (readBuffer.hasRemaining()) {
                ...
                boolean bl2 = eventState = readBuffer.get() != 0;
                if (Mouse.isGrabbed()) {
    ...
    static {
        ...
        allowNegativeMouseCoords = Mouse.getPrivilegedBoolean("org.lwjgl.input.Mouse.allowNegativeMouseCoords");
    }
}
