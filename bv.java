...
extends js {
    ...
    public boolean a(cy cy2, Random random, int n2, int n3, int n4) {
        int n5;
        int n6;
        while (n3 > 0 && cy2.a(n2 -= 8, n3, n4 -= 8) == 0) {
            --n3;
        }
        n3 -= 4;
        ...
        for (n6 = 0; n6 < 16; ++n6) {
            for (int i5 = 0; i5 < 16; ++i5) {
                for (n5 = 0; n5 < 8; ++n5) {
                    boolean bl2;
                    boolean bl3 = bl2 = !arrbl[(n6 * 16 + i5) * 8 + n5] && (n6 < 15 && arrbl[((n6 + 1) * 16 + i5) * 8 + n5] || n6 > 0 && arrbl[((n6 - 1) * 16 + i5) * 8 + n5] || i5 < 15 && arrbl[(n6 * 16 + (i5 + 1)) * 8 + n5] || i5 > 0 && arrbl[(n6 * 16 + (i5 - 1)) * 8 + n5] || n5 < 7 && arrbl[(n6 * 16 + i5) * 8 + (n5 + 1)] || n5 > 0 && arrbl[(n6 * 16 + i5) * 8 + (n5 - 1)]);
                    if (!bl2) continue;
        ...
        for (n6 = 0; n6 < 16; ++n6) {
            for (int i6 = 0; i6 < 16; ++i6) {
                for (n5 = 0; n5 < 8; ++n5) {
                    if (!arrbl[(n6 * 16 + i6) * 8 + n5]) continue;
        ...
        for (n6 = 0; n6 < 16; ++n6) {
            for (int i7 = 0; i7 < 16; ++i7) {
                for (n5 = 4; n5 < 8; ++n5) {
                    if (!arrbl[(n6 * 16 + i7) * 8 + n5] || cy2.a(n2 + n6, n3 + n5 - 1, n4 + i7) != nq.v.bh || cy2.a(ch.a, n2 + n6, n3 + n5, n4 + i7) <= 0) continue;
