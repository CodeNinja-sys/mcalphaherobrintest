...
extends ad {
    ...
    public void a() {
        ++this.g;
        byte[] arrby = this.h[this.g & 0x1F];
        for (int i2 = 0; i2 < 256; ++i2) {
            int n2 = arrby[i2 * 4 + 0] & 0xFF;
            int n3 = arrby[i2 * 4 + 1] & 0xFF;
            int n4 = arrby[i2 * 4 + 2] & 0xFF;
            int n5 = arrby[i2 * 4 + 3] & 0xFF;
            if (this.c) {
