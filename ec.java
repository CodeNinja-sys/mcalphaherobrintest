    ...
    public void a(hf hf2, double d2, double d3, double d4, float f2, float f3) {
        ...
        try {
            ...
            if (hf2.O > 0) {
                ...
                if ((f4 = fi.c((float)f4)) > 1.0f) {
                    f4 = 1.0f;
                }
                GL11.glRotatef(f4 * this.a(hf2), 0.0f, 0.0f, 1.0f);
            }
            f4 = 0.0625f;
            GL11.glEnable(32826);
            GL11.glScalef(-1.0f, -1.0f, 1.0f);
            this.a(hf2, f3);
            GL11.glTranslatef(0.0f, -24.0f * f4 - 0.0078125f, 0.0f);
            ...
            if ((n2 >> 24 & 0xFF) > 0 || hf2.L > 0 || hf2.O > 0) {
                ...
                if (hf2.L > 0 || hf2.O > 0) {
                    GL11.glColor4f(f11, 0.0f, 0.0f, 0.4f);
                    this.e.b(f10, f9, f8, f6 - f5, f7, f4);
                ...
                if ((n2 >> 24 & 0xFF) > 0) {
                    ...
                    GL11.glColor4f(f12, f13, f14, f15);
                    this.e.b(f10, f9, f8, f6 - f5, f7, f4);
