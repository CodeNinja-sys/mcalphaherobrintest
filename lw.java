...
public abstract class lw {
    ...
    public void B() {
        ...
        if (this.h_()) {
            if (!this.bi && !this.c) {
                float f2;
                float f3;
                float f4 = fi.a((double)(this.az * this.az * (double)0.2f + this.aA * this.aA + this.aB * this.aB * (double)0.2f)) * 0.2f;
                if (f4 > 1.0f) {
                    f4 = 1.0f;
                }
    ...
    public void d(double d2, double d3, double d4) {
        ...
        d5 = this.ay - d7;
        if (this.aT && !bl2) {
            this.aS = (float)((double)this.aS + (double)fi.a((double)(d14 * d14 + d5 * d5)) * 0.6);
            int n6 = fi.b(this.aw);
    ...
    public boolean a(hb hb2) {
        ...
        int n4 = fi.b(this.aw);
        int n5 = this.as.a(n4, n3 = fi.d((float)fi.b(d2)), n2 = fi.b(this.ay));
    ...
    public void a(float f2, float f3, float f4) {
        float f5 = fi.c((float)(f2 * f2 + f3 * f3));
        if (f5 < 0.01f) {
            return;
        }
        if (f5 < 1.0f) {
        ...
        f5 = f4 / f5;
        float f6 = fi.a((float)(this.aC * (float)Math.PI / 180.0f));
        float f7 = fi.b((float)(this.aC * (float)Math.PI / 180.0f));
    ...
    public float e(lw lw2) {
        ...
        return fi.c((float)(f2 * f2 + f3 * f3 + f4 * f4));
    }
    ...
    public double f(double d2, double d3, double d4) {
        ...
        double d6 = this.ax - d3;
        double d7 = this.ay - d4;
        return fi.a((double)(d5 * d5 + d6 * d6 + d7 * d7));
    }
    ...
    public void g(lw lw2) {
        ...
        double d4 = fi.a((double)d2, (double)d3);
        if (d4 >= (double)0.01f) {
            d4 = fi.a((double)d4);
            d2 /= d4;
            d3 /= d4;
    ...
    public void e(iq iq2) {
        ...
        this.b(0.0, 0.0, 0.0);
        this.az = ((mh)ly3.a((int)0)).a;
        this.aA = ((mh)ly3.a((int)1)).a;
        this.aB = ((mh)ly3.a((int)2)).a;
        this.aV = this.aw = ((mh)ly2.a((int)0)).a;
        this.at = this.aw;
        this.aW = this.ax = ((mh)ly2.a((int)1)).a;
        this.au = this.ax;
        this.aX = this.ay = ((mh)ly2.a((int)2)).a;
        this.av = this.ay;
        this.aE = this.aC = ((h)ly4.a((int)0)).a;
        this.aF = this.aD = ((h)ly4.a((int)1)).a;
