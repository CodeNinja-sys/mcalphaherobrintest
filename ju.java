...
extends dl {
    protected void a(int n2, int n3, byte[] arrby, double d2, double d3, double d4) {
        this.a(n2, n3, arrby, d2, d3, d4, 1.0f + this.b.nextFloat() * 6.0f, 0.0f, 0.0f, -1, -1, 0.5);
    }
    ...
    protected void a(int n2, int n3, byte[] arrby, double d2, double d3, double d4, float f2, float f3, float f4, int n4, int n5, double d5) {
        ...
        while (n4 < n5) {
            double d8 = 1.5 + (double)(fi.a((float)((float)n4 * (float)Math.PI / (float)n5)) * f2 * 1.0f);
            double d9 = d8 * d5;
            float f7 = fi.b((float)f4);
            float f8 = fi.a((float)f4);
            d2 += (double)(fi.b((float)f3) * f7);
            d3 += (double)f8;
            d4 += (double)(fi.a((float)f3) * f7);
                    ...
                    for (n9 = n10; !bl4 && n9 < n11; ++n9) {
                        for (int i2 = n14; !bl4 && i2 < n15; ++i2) {
                            for (int i3 = n13 + 1; !bl4 && i3 >= n12 - 1; --i3) {
                                ...
                                if (arrby[n8] == nq.C.bh || arrby[n8] == nq.D.bh) {
                                    bl4 = true;
                                }
                        ...
                        for (n9 = n10; n9 < n11; ++n9) {
                            ...
                            for (n8 = n14; n8 < n15; ++n8) {
                                ...
                                for (int i4 = n13 - 1; i4 >= n12; --i4) {
                                    ...
                                    if (d16 > -0.7 && d14 * d14 + d16 * d16 + d15 * d15 < 1.0 && ((by2 = arrby[n16]) == nq.bb.bh || by2 == nq.v.bh || by2 == nq.u.bh)) {
                                        arrby[n16] = 0;
                                    }
                                    --n16;
                                }
    ...
    protected void a(cy cy2, int n2, int n3, int n4, int n5, byte[] arrby) {
        ...
        for (int i2 = 0; i2 < n6; ++i2) {
            ...
            for (int i3 = 0; i3 < n7; ++i3) {
                ...
                this.a(n4, n5, arrby, d2, d3, d4, f4 * 2.0f, f2, f3, 0, 0, 0.5);
            }
        }
    }
}
