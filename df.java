...
extends js {
    ...
    public boolean a(cy cy2, Random random, int n2, int n3, int n4) {
        ...
        double d2 = (float)(n2 + 8) + fi.a((float)f2) * (float)this.b / 8.0f;
        double d3 = (float)(n2 + 8) - fi.a((float)f2) * (float)this.b / 8.0f;
        double d4 = (float)(n4 + 8) + fi.b((float)f2) * (float)this.b / 8.0f;
        double d5 = (float)(n4 + 8) - fi.b((float)f2) * (float)this.b / 8.0f;
        ...
        for (int i2 = 0; i2 <= this.b; ++i2) {
            ...
            double d12 = (double)(fi.a((float)((float)i2 * (float)Math.PI / (float)this.b)) + 1.0f) * d11 + 1.0;
            double d13 = (double)(fi.a((float)((float)i2 * (float)Math.PI / (float)this.b)) + 1.0f) * d11 + 1.0;
