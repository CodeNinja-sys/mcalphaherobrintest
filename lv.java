...
extends lw {
    ...
    public lv(cy cy2, hf hf2) {
        ...
        this.aO = 0.0f;
        this.az = -fi.a((float)(this.aC / 180.0f * (float)Math.PI)) * fi.b((float)(this.aD / 180.0f * (float)Math.PI));
        this.aB = fi.b((float)(this.aC / 180.0f * (float)Math.PI)) * fi.b((float)(this.aD / 180.0f * (float)Math.PI));
        this.aA = -fi.a((float)(this.aD / 180.0f * (float)Math.PI));
    ...
    public void e_() {
        ...
        for (int i2 = 0; i2 < list.size(); ++i2) {
            ...
            if (!lw3.n_() || lw3 == this.b && this.i < 5 || (nx3 = (co2 = lw3.aG.b(f2 = 0.3f, f2, f2)).a(ao2, ao3)) == null || !((d3 = ao2.c(nx3.f)) < d2) && d2 != 0.0) continue;
            lw2 = lw3;
            d2 = d3;
        }
        if (lw2 != null) {
        ...
        if (nx2 != null) {
            if (nx2.g != null) {
                ...
                float f4 = fi.a((double)(this.az * this.az + this.aA * this.aA + this.aB * this.aB));
        ...
        this.ax += this.aA;
        this.ay += this.aB;
        float f5 = fi.a((double)(this.az * this.az + this.aB * this.aB));
