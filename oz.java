...
public class oz {
    ...
    public float[] b(float f2, float f3) {
        float f4;
        float f5 = 0.4f;
        float f6 = fi.b((float)(f2 * (float)Math.PI * 2.0f)) - 0.0f;
        if (f6 >= (f4 = -0.0f) - f5 && f6 <= f4 + f5) {
            float f7 = (f6 - f4) / f5 * 0.5f + 0.5f;
            float f8 = 1.0f - (1.0f - fi.a((float)(f7 * (float)Math.PI))) * 0.99f;
            f8 *= f8;
    ...
    public ao a(float f2, float f3) {
        float f4 = fi.b((float)(f2 * (float)Math.PI * 2.0f)) * 2.0f + 0.5f;
        if (f4 < 0.0f) {
            f4 = 0.0f;
        }
        if (f4 > 1.0f) {
        ...
        float f7 = 1.0f;
        return ao.b(f5 *= f4 * 0.94f + 0.06f, f6 *= f4 * 0.94f + 0.06f, f7 *= f4 * 0.91f + 0.09f);
    }
