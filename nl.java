...
extends nb {
    ...
    public void a(float f2, boolean bl2, int n2, int n3) {
        ...
        if (this.j > 0) {
            ...
            if (n5 > 0) {
                GL11.glPushMatrix();
                GL11.glTranslatef(n7 / 2, n8 - 48, 0.0f);
                GL11.glEnable(3042);
        ...
        GL11.glDisable(3008);
        GL11.glPushMatrix();
        GL11.glTranslatef(0.0f, n8 - 48, 0.0f);
    ...
    private void b(float f2, int n2, int n3) {
        ...
        GL11.glBindTexture(3553, this.g.n.a("/terrain.png"));
    ...
    private void a(int n2, int n3, int n4, float f2) {
        ...
        float f3 = (float)fp2.b - f2;
        if (f3 > 0.0f) {
            GL11.glPushMatrix();
            float f4 = 1.0f + f3 / 5.0f;
            GL11.glTranslatef(n3 + 8, n4 + 12, 0.0f);
