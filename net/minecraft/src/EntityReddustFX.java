...
extends EntityFX {
    ...
    public EntityReddustFX(World world, double d2, double d1, double d22) {
        this(world, d2, d1, d22, 1.0f);
    }

    public EntityReddustFX(World world, double d2, double d1, double d22, float f2) {
    ...
    public void func_406_a(Tessellator tessellator, float f2, float f1, float f22, float f3, float f4, float f5) {
        ...
        this.field_665_g = this.field_673_a * f6;
