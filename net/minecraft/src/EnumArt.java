...
public enum EnumArt {
    ...
    private EnumArt(String s1, int j2, int k2, int l2, int i1) {
        this.field_1624_y = s1;
        this.field_1623_z = j2;
        this.field_1636_A = k2;
        this.field_1634_B = l2;
        this.field_1632_C = i1;
    }
}
