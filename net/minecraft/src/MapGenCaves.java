...
extends MapGenBase {
    protected void func_870_a(int i2, int j2, byte[] abyte0, double d2, double d1, double d22) {
        this.func_869_a(i2, j2, abyte0, d2, d1, d22, 1.0f + this.field_1305_b.nextFloat() * 6.0f, 0.0f, 0.0f, -1, -1, 0.5);
    }

    protected void func_869_a(int i2, int j2, byte[] abyte0, double d2, double d1, double d22, float f2, float f1, float f22, int k2, int l2, double d3) {
        double d4 = i2 * 16 + 8;
        double d5 = j2 * 16 + 8;
        float f3 = 0.0f;
        float f4 = 0.0f;
        ...
        while (k2 < l2) {
            ...
            if (!flag && k2 == j1 && f2 > 1.0f) {
                this.func_869_a(i2, j2, abyte0, d2, d1, d22, random.nextFloat() * 0.5f + 0.5f, f1 - 1.570796f, f22 / 3.0f, k2, l2, 1.0);
                this.func_869_a(i2, j2, abyte0, d2, d1, d22, random.nextFloat() * 0.5f + 0.5f, f1 + 1.570796f, f22 / 3.0f, k2, l2, 1.0);
                return;
            }
    ...
    protected void func_868_a(World world, int i2, int j2, int k2, int l2, byte[] abyte0) {
        int i1 = this.field_1305_b.nextInt(this.field_1305_b.nextInt(this.field_1305_b.nextInt(40) + 1) + 1);
        ...
        for (int j1 = 0; j1 < i1; ++j1) {
            ...
            if (this.field_1305_b.nextInt(4) == 0) {
                this.func_870_a(k2, l2, abyte0, d2, d1, d22);
            ...
            for (int l1 = 0; l1 < k1; ++l1) {
                ...
                this.func_869_a(k2, l2, abyte0, d2, d1, d22, f22, f2, f1, 0, 0, 1.0);
            }
        }
    }
}
