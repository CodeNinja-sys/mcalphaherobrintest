...
extends Panel {
    public PanelCrashReport(UnexpectedThrowable unexpectedthrowable) {
        ...
        String s22 = "";
        try {
            s22 = s22 + "Generated " + new SimpleDateFormat().format(new Date()) + "\n";
            s22 = s22 + "\n";
            s22 = s22 + "Minecraft: Minecraft Alpha Herobrine Test\n";
            s22 = s22 + "OS: " + System.getProperty("os.name") + " (" + System.getProperty("os.arch") + ") version " + System.getProperty("os.version") + "\n";
            s22 = s22 + "Java: " + System.getProperty("java.version") + ", " + System.getProperty("java.vendor") + "\n";
            s22 = s22 + "VM: " + System.getProperty("java.vm.name") + " (" + System.getProperty("java.vm.info") + "), " + System.getProperty("java.vm.vendor") + "\n";
            s22 = s22 + "LWJGL: " + Sys.getVersion() + "\n";
            s1 = GL11.glGetString(7936);
            s22 = s22 + "OpenGL: " + GL11.glGetString(7937) + " version " + GL11.glGetString(7938) + ", " + GL11.glGetString(7936) + "\n";
        }
        catch (Throwable throwable) {
            s22 = s22 + "[failed to get system properties (" + throwable + ")]\n";
        }
        s22 = s22 + "\n";
        s22 = s22 + s2;
        String s3 = "";
        s3 = s3 + "\n";
        s3 = s3 + "\n";
        if (s2.contains("Pixel format not accelerated")) {
