...
public class RenderList {
    ...
    public void func_861_a(int i2, int j2, int k2, double d2, double d1, double d22) {
        this.field_1235_h = true;
        this.field_1236_g.clear();
        this.field_1242_a = i2;
        this.field_1241_b = j2;
        this.field_1240_c = k2;
        this.field_1239_d = (float)d2;
        this.field_1238_e = (float)d1;
        this.field_1237_f = (float)d22;
    }

    public boolean func_862_a(int i2, int j2, int k2) {
        if (!this.field_1235_h) {
            return false;
        }
        return i2 == this.field_1242_a && j2 == this.field_1241_b && k2 == this.field_1240_c;
    }

    public void func_858_a(int i2) {
        this.field_1236_g.put(i2);
