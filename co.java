...
public class co {
    ...
    public nx a(ao ao2, ao ao3) {
        ao ao4 = ao2.a(ao3, this.a);
        ao ao5 = ao2.a(ao3, this.d);
        ao ao6 = ao2.b(ao3, this.b);
        ao ao7 = ao2.b(ao3, this.e);
        ao ao8 = ao2.c(ao3, this.c);
        ao ao9 = ao2.c(ao3, this.f);
        if (!this.b(ao4)) {
            ao4 = null;
        }
        if (!this.b(ao5)) {
