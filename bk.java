...
public class bk {
    ...
    public boolean c(nq nq2, int n2, int n3, int n4) {
        ...
        float f11 = 0.0625f;
        float f12 = 0.625f;
        arrao[0] = ao.b(-f10, 0.0, -f11);
        arrao[1] = ao.b(f10, 0.0, -f11);
        arrao[2] = ao.b(f10, 0.0, f11);
        arrao[3] = ao.b(-f10, 0.0, f11);
        arrao[4] = ao.b(-f10, f12, -f11);
        arrao[5] = ao.b(f10, f12, -f11);
        arrao[6] = ao.b(f10, f12, f11);
        arrao[7] = ao.b(-f10, f12, f11);
        for (int i2 = 0; i2 < 8; ++i2) {
            if (bl3) {
                arrao[i2].c -= 0.0625;
                arrao[i2].a(0.69813174f);
            } else {
                arrao[i2].c += 0.0625;
                arrao[i2].a(-0.69813174f);
            }
            if (n6 == 6) {
                arrao[i2].b(1.5707964f);
            }
            if (n6 < 5) {
                arrao[i2].b -= 0.375;
                arrao[i2].a(1.5707964f);
                if (n6 == 4) {
                    arrao[i2].b(0.0f);
                }
                if (n6 == 3) {
                    arrao[i2].b((float)Math.PI);
                }
                if (n6 == 2) {
                    arrao[i2].b(1.5707964f);
                }
                ...
                arrao[i2].a += (double)n2 + 0.5;
                arrao[i2].b += (double)((float)n3 + 0.5f);
                arrao[i2].c += (double)n4 + 0.5;
                continue;
            }
            arrao[i2].a += (double)n2 + 0.5;
            arrao[i2].b += (double)((float)n3 + 0.125f);
            arrao[i2].c += (double)n4 + 0.5;
        }
        ao ao2 = null;
        ao ao3 = null;
    ...
    public boolean j(nq nq2, int n2, int n3, int n4) {
        ...
        boolean[] arrbl = new boolean[]{nq2.b(this.a, n2, n3, n4 - 1, 2), nq2.b(this.a, n2, n3, n4 + 1, 3), nq2.b(this.a, n2 - 1, n3, n4, 4), nq2.b(this.a, n2 + 1, n3, n4, 5)};
        if (!(bl2 || bl3 || arrbl[0] || arrbl[1] || arrbl[2] || arrbl[3])) {
            return false;
        }
        boolean bl4 = false;
        float f5 = 0.5f;
        ...
        if (this.d || bl2) {
            ...
            f4 = fi.a((float)f13) * 8.0f / 256.0f;
            f3 = fi.b((float)f13) * 8.0f / 256.0f;
