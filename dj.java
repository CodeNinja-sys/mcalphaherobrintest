...
extends bp {
    ...
    public void a(int n2, int n3, float f2) {
        ...
        float f3 = 1.8f - fi.e((float)(fi.a((float)((float)(System.currentTimeMillis() % 1000L) / 1000.0f * (float)Math.PI * 2.0f)) * 0.1f));
    ...
    private void a(float f2) {
        ...
        n2 = 120 * kl2.a;
        GLU.gluPerspective(70.0f, (float)this.b.c / (float)n2, 0.05f, 100.0f);
        GL11.glViewport(0, this.b.d - n2, this.b.c, n2);
