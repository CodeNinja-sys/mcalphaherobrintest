...
extends gm {
    ...
    public void a(float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        this.d.d = fi.b((float)(f2 * 0.6662f)) * 1.4f * f3;
        this.e.d = fi.b((float)(f2 * 0.6662f + (float)Math.PI)) * 1.4f * f3;
        this.f.d = fi.b((float)(f2 * 0.6662f + (float)Math.PI)) * 1.4f * f3;
        this.g.d = fi.b((float)(f2 * 0.6662f)) * 1.4f * f3;
    }
}
