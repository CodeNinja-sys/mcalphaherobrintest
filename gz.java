...
public class gz {
    ...
    private gz() {
        ...
        for (fr fr2 : this.m.values()) {
            fr2.a(this);
        }
    }

    public fr a(Class class_) {
        fr fr2 = (fr)this.m.get(class_);
        if (fr2 == null && class_ != ji.class) {
            fr2 = this.a(class_.getSuperclass());
            this.m.put(class_, fr2);
        }
        return fr2;
    }
