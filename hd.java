...
extends bp {
    ...
    public void a() {
        ...
        ((gh)this.e.get((int)0)).g = this.i.length() > 0;
    }
    ...
    protected void a(gh gh2) {
        ...
        if (gh2.f == 1) {
            ...
            this.b.y.b();
            String[] arrstring = this.i.split(":");
            this.b.a(new og(this.b, arrstring[0], arrstring.length > 1 ? this.a(arrstring[1], 25565) : 25565));
        }
    }
